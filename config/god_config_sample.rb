RAILS_ROOT = "/home/shopstag/rails_apps/SoletronStage"

%w{12002 12003 12004 12005 12006 12007 12008 12009 12010 12011}.each do |port|

  God.watch do |w|
    w.name = "soletron-stage-bastet-#{port}"
