...
class NamespacePromoTables < ActiveRecord::Migration
  ...
  def self.down
    ...
    # remove old promo preferences as columns
    remove_column :spree_activators, :usage_limit, :integer
    remove_column :spree_activators, :match_policy, :string, :default => 'all'
    remove_column :spree_activators, :code, :string
    remove_column :spree_activators, :advertise, :boolean, :default => false
  end
end